...
document.body.onload = startGame();     //funzione impostata per caricare una volta caricata la pagina
...
function playAgain() {                  //funzione per ricaricare la pagina e riniziare il gioco
    modal.classList.remove("active");
    startGame();
}

function startGame() {                  //funzione inizio gioco
    ...
    for (var i = 0; i < 24; i++) {
        ...
        var box = document.createElement('div');        //aggiungere un div per ogni elemento icon
...
function openModal() {                      //se le icone trovate sono 24 -> attivare modal
...
function closeModal() {                     //disattivare il modal dopo che i ha cliccato l'icona di chiusura
