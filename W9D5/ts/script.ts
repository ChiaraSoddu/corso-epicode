...
class User implements Smartphone {
    carica:number; //istanza
    numeroChiamate: number; 
    tariffa:number = 0.004 //centesimi al secondo 
        constructor(carica:number, numeroChiamate: number,){ // il constructor è un metodo speciale della classe
            this.carica = carica,
    ...
    chiamata(minutiDurata: number): void{ //void non è specificato
...
// TASTO PER CHIAMARE 
let chiama = document.getElementById("chiama");
...
chiudi?.addEventListener('click', () =>{//1) prendi il valore tempo e calcola la tariffa oraria
    let trascorso: number = o1*60 + m1*60 + s1;    
    FirstUser.chiamata(trascorso);
    let saldoResiduo1 = <HTMLInputElement> document.getElementById("credito1")
    saldoResiduo1.innerHTML= 
    `<p>Costo chiamata: -${trascorso*0.003}€ - <br> Residuo: ${FirstUser.numero404()}€ </p>` //costo e credito residuo    
    chiudiChiamata1();

    let nChiamate1 = <HTMLInputElement> document.getElementById("nChiamate1")
...
chiama2?.addEventListener('click', () =>{
    start2()    
});

// TASTO PER CHIUDERE
let chiudi2 = document.getElementById("chiudi2");
chiudi2?.addEventListener('click', () =>{
    let trascorso: number = o2*60 + m2*60 + s2;    
    SecondUser.chiamata(trascorso);
    let saldoResiduo2 = <HTMLInputElement> document.getElementById("credito2")
    saldoResiduo2.innerHTML= 
    `<p>Costo chiamata: - ${trascorso*0.003}€ - <br> Residuo: ${SecondUser.numero404()}€ </p>` //costo e credito residuo

    chiudiChiamata2();

    let nChiamate2 = <HTMLInputElement> document.getElementById("nChiamate2")
...
chiama3?.addEventListener('click', () =>{
    start3()
});

// TASTO PER CHIUDERE
let chiudi3 = document.getElementById("chiudi3");
chiudi3?.addEventListener('click', () =>{
    let trascorso: number = o3*60 + m3+60 +s3; 
    ThirdUser.chiamata(trascorso);
    let saldoResiduo3 = <HTMLInputElement> document.getElementById("credito3")
    saldoResiduo3.innerHTML= 
    `<p>Costo chiamata: - ${trascorso*0.003}€ - <br> Residuo: ${ThirdUser.numero404()}€ </p>` //costo e credito residuo   

    chiudiChiamata3();

    let nChiamate3 = <HTMLInputElement> document.getElementById("nChiamate3")
...
// STAMPA OROLOGIO 
function orologio1(){
    let orologio1 = <HTMLInputElement> document.getElementById("time1")
    orologio1.innerHTML=
...
function orologio2(){
    let orologio2 = <HTMLInputElement> document.getElementById("time2")
    orologio2.innerHTML=
...
function orologio3(){
   let orologio3 = <HTMLInputElement> document.getElementById("time3")
    orologio3.innerHTML=
...
function UTENTE1() { // Funziona solo con il live server
